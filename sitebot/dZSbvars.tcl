...
set variables(UPDATE_VBR)		"%pf %u_name %g_name %t_files %u_speed %t_mbytes %filename %releasename %u_tagline %genre %year %bitrate %sampling %mode %audio %a_stream %artist %album %title %codec %layer"
