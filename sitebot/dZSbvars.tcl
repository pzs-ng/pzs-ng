...
set variables(RACE_VIDEO)		"%pf %u_name %g_name {%a_name %a_gname} %releasename %u_speed %filename %t_duration %t_percent %u_count %g_count %t_upfiles %t_files %missing_files %u_tagline {%r_name %r_gname} %t_timeleft"
...
set variables(UPDATE_VIDEO)		"%pf %u_name %g_name %t_files %u_speed %t_mbytes %filename %releasename %u_tagline %t_timeleft"
set variables(UPDATE_VBR)		"%pf %u_name %g_name %t_files %u_speed %t_mbytes %filename %releasename %u_tagline %genre %year %bitrate %sampling %mode %audio %a_stream %a_version %artist %album %title %codec %layer %t_timeleft"
...
set variables(COMPLETE_ZIP)		"%pf %releasename %t_mbytes %t_files %t_avgspeed %r_avgspeed %t_duration %u_name %g_name %filename %u_tagline %g_racer_position %g_racer_name %g_racer_mbytes %g_racer_files %g_racer_percent %g_racer_avgspeed %u_racer_position %u_racer_name %g_racer_name %u_racer_mbytes %u_racer_files %u_racer_percent %u_racer_avgspeed %u_racer_dayup %u_racer_wkup %u_racer_monthup %u_racer_allup"
set variables(COMPLETE_OTHER)		"%pf %releasename %t_mbytes %t_files %t_avgspeed %r_avgspeed %t_duration %u_name %g_name %filename %u_tagline %g_racer_position %g_racer_name %g_racer_mbytes %g_racer_files %g_racer_percent %g_racer_avgspeed %u_racer_position %u_racer_name %g_racer_name %u_racer_mbytes %u_racer_files %u_racer_percent %u_racer_avgspeed %u_racer_dayup %u_racer_wkup %u_racer_monthup %u_racer_allup"
set variables(COMPLETE_VIDEO)		"%pf %releasename %t_mbytes %t_files %t_avgspeed %r_avgspeed %t_duration %u_name %g_name %filename %u_tagline %g_racer_position %g_racer_name %g_racer_mbytes %g_racer_files %g_racer_percent %g_racer_avgspeed %u_racer_position %u_racer_name %g_racer_name %u_racer_mbytes %u_racer_files %u_racer_percent %u_racer_avgspeed %u_racer_dayup %u_racer_wkup %u_racer_monthup %u_racer_allup"
set variables(COMPLETE_AUDIO_CBR)	"%pf %releasename %t_mbytes %t_files %t_avgspeed %r_avgspeed %t_duration %u_name %g_name %genre %year %bitrate %sampling %mode %audio %artist %album %title %codec %layer %filename %u_tagline %g_racer_position %g_racer_name %g_racer_mbytes %g_racer_files %g_racer_percent %g_racer_avgspeed %u_racer_position %u_racer_name %g_racer_name %u_racer_mbytes %u_racer_files %u_racer_percent %u_racer_avgspeed %u_racer_dayup %u_racer_wkup %u_racer_monthup %u_racer_allup"
set variables(COMPLETE_AUDIO_VBR)	"%pf %releasename %t_mbytes %t_files %t_avgspeed %r_avgspeed %t_duration %u_name %g_name %genre %year %bitrate %sampling %mode %audio %a_stream %a_version %artist %album %title %codec %layer %filename %u_tagline %g_racer_position %g_racer_name %g_racer_mbytes %g_racer_files %g_racer_percent %g_racer_avgspeed %u_racer_position %u_racer_name %g_racer_name %u_racer_mbytes %u_racer_files %u_racer_percent %u_racer_avgspeed %u_racer_dayup %u_racer_wkup %u_racer_monthup %u_racer_allup"
