...
set variables(UPDATE_VBR)		"%pf %u_name %g_name %t_files %u_speed %genre %year %bitrate %sampling %mode %audio %a_stream %artist %album %title %codec %layer %u_tagline %filename %releasename"
set variables(UPDATE_CBR)		"%pf %u_name %g_name %t_files %u_speed %genre %year %bitrate %sampling %mode %audio %artist %album %title %codec %layer %u_tagline %filename %releasename"
...
set variables(COMPLETE_AUDIO_VBR)	"%pf %releasename %t_mbytes %t_files %t_avgspeed %r_avgspeed %t_duration %u_name %g_name %genre %year %bitrate %sampling %mode %audio %a_stream %artist %album %title %codec %layer %filename %u_tagline"
