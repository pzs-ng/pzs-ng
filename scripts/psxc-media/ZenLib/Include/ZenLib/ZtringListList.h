...
public :
    ...
    /// @brief Read a string
    Ztring Read (size_type Pos0, size_type Pos1) const;
    /// @brief Return [Pos][Pos1], Pos=First occurency of Pos0 in [xxx][0]
    Ztring Read (const Ztring &Pos0, size_type Pos1=1) const       {return Read(Pos0, 0 , Pos1);};
    /// @brief Return [Pos][Pos1], Pos=First occurency of Pos0 in [xxx][Pos0_1]
    Ztring Read (const Ztring &Pos0, size_type Pos0_1, size_type Pos1) const          {return Read(Pos0, _T(""), Pos0_1, Pos1);};
    /// @brief Return [Pos][Pos1], Pos=First occurency of Pos0 in [xxx][0], with default value
    Ztring Read (const Ztring &Pos0, Ztring Default, size_type Pos1=1) const       {return Read(Pos0, Default, 0 , Pos1);};
    /// @brief Return [Pos][Pos1], Pos=First occurency of Pos0 in [xxx][Pos0_1], with default value
    Ztring Read (const Ztring &Pos0, Ztring Default, size_type Pos0_1, size_type Pos1) const;
