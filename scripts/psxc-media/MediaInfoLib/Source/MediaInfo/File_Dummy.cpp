...
void File_Dummy::Fill_Dummy_General()
{
    ...
    General[Pos](_T("RadioStation"))=_T("RadioStation");
    General[Pos](_T("RadioStation/Owner"))=_T("RadioStation/Owner");
    General[Pos](_T("RadioStation/URL"))=_T("RadioStation/URL");
