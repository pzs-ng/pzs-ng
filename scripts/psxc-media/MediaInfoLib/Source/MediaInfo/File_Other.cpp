...
void File_Other::Read_File()
{
    ...
    else if (CC8(Buffer+58)==CC8("SIDMON I")) {Format=_T("Amiga Sidmon");}
    ...
    else if (CC4(Buffer)==CC4("wvpk")) {Format=_T("WavePack"); Url=_T("http://www.wavpack.com/downloads.html"); Extensions=_T("wv");}
    ...
    else if (CC4(Buffer+0x104)==0xCEED6666) {Format=_T("GameBoy");}
    else if (CC4(Buffer+0x100)==CC4("SEGA")) {Format=_T("MegaDrive");}
    else if (CC4(Buffer+0x280)==CC4("EAGN")) {Format=_T("SupeMegaDrive");}
    else if (CC4(Buffer+0x280)==CC4("EAMG")) {Format=_T("SupeMegaDrive");}
