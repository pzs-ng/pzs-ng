...
#endif
#ifndef incomplete_base_sample_indicator_is_defaulted
printf("#define incomplete_base_sample_indicator          %s\n", stringify(incomplete_base_sample_indicator));
#endif
...
#endif
#ifndef incomplete_generic1_base_sample_indicator_is_defaulted
printf("#define incomplete_generic1_base_sample_indicator %s\n", stringify(incomplete_generic1_base_sample_indicator));
#endif
...
#endif
#ifndef incomplete_generic1_sample_indicator_is_defaulted
printf("#define incomplete_generic1_sample_indicator      %s\n", stringify(incomplete_generic1_sample_indicator));
#endif
...
#endif
#ifndef incomplete_generic2_base_sample_indicator_is_defaulted
printf("#define incomplete_generic2_base_sample_indicator %s\n", stringify(incomplete_generic2_base_sample_indicator));
#endif
...
#endif
#ifndef incomplete_generic2_sample_indicator_is_defaulted
printf("#define incomplete_generic2_sample_indicator      %s\n", stringify(incomplete_generic2_sample_indicator));
#endif
...
#endif
#ifndef incomplete_sample_indicator_is_defaulted
printf("#define incomplete_sample_indicator               %s\n", stringify(incomplete_sample_indicator));
#endif
