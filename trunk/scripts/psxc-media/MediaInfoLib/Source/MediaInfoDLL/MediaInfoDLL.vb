...
Public Class MediaInfo
    ...
    Private Declare Unicode Function MediaInfo_Open Lib "MediaInfo.DLL" (ByVal Handle As Integer, ByVal FileName As String) As Integer
    Private Declare Unicode Sub MediaInfo_Close Lib "MediaInfo.DLL" (ByVal Handle As Integer)
    Private Declare Unicode Function MediaInfo_Inform Lib "MediaInfo.DLL" (ByVal Handle As Integer, ByVal Reserved As Integer) As IntPtr
    Private Declare Unicode Function MediaInfo_GetI Lib "MediaInfo.DLL" (ByVal Handle As Integer, ByVal StreamKind As StreamKind, ByVal StreamNumber As Integer, ByVal Parameter As Integer, ByVal KindOfInfo As InfoKind) As IntPtr 'See MediaInfoDLL.h for enumeration values
    Private Declare Unicode Function MediaInfo_Get Lib "MediaInfo.DLL" (ByVal Handle As Integer, ByVal StreamKind As StreamKind, ByVal StreamNumber As Integer, ByVal Parameter As String, ByVal KindOfInfo As InfoKind, ByVal KindOfSearch As InfoKind) As IntPtr
    Private Declare Unicode Function MediaInfo_Option Lib "MediaInfo.DLL" (ByVal Handle As Integer, ByVal Option_ As String, ByVal Value As String) As IntPtr
    ...
    Private Declare Unicode Function MediaInfo_Count_Get Lib "MediaInfo.DLL" (ByVal Handle As Integer, ByVal StreamKind As StreamKind, ByVal StreamNumber As Integer) As Integer 'see MediaInfoDLL.h for enumeration values
    ...
    End Function
    Function Count_Get(ByVal StreamKind As StreamKind, Optional ByVal StreamNumber As Integer = -1) As Integer
