...
xcopy ..\Project\MSVC\Example\*.vc MediaInfoDLL_Win32\Developpers\Project\MSVC\Example\
xcopy ..\Project\MSVC\Example\*.vcproj MediaInfoDLL_Win32\Developpers\Project\MSVC\Example\
xcopy ..\Project\MSVC\Example\*.h MediaInfoDLL_Win32\Developpers\Project\MSVC\Example\
xcopy ..\Project\MSVC\Example\*.cpp MediaInfoDLL_Win32\Developpers\Project\MSVC\Example\
xcopy ..\Project\MSVC\Example\*.res* MediaInfoDLL_Win32\Developpers\Project\MSVC\Example\
xcopy ..\Project\MSVC\Example\*.rc MediaInfoDLL_Win32\Developpers\Project\MSVC\Example\
...
@rem --- Copying : Libs ---
xcopy ..\Release\BCB\DLL\*.lib MediaInfoDLL_Win32\Developpers\Release\BCB\DLL\
xcopy ..\Release\MSVC\DLL\*.lib MediaInfoDLL_Win32\Developpers\Release\MSVC\DLL\
...
rem --- Copying : DLL ---
xcopy MSVC\Dll\*.dll MediaInfoDLL_Win32\
xcopy ..\..\MediaInfo\Release\MSVC\Dll\*.dll MediaInfoDLL_Win32\
