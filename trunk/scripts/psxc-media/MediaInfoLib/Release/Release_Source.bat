...
xcopy ..\Project\GCC\configure* MediaInfo_Lib_Source\Project\GCC\ /S
xcopy ..\Project\GCC\Make* MediaInfo_Lib_Source\Project\GCC\ /S
xcopy ..\Project\GCC\*.mak MediaInfo_Lib_Source\Project\GCC\ /S
