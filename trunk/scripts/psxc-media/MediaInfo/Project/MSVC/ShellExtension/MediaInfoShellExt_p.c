...
/* Object interface: IMediaInfoShellExt_, ver. 0.0,
   GUID={0x1E0C0599,0x6105,0x4999,{0x99,0xF5,0x7B,0x5D,0xE4,0x18,0x60,0xBE}} */
...
static const MIDL_SERVER_INFO IMediaInfoShellExt__ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(7) _IMediaInfoShellExt_ProxyVtbl = 
{
    0,
...
static const PRPC_STUB_FUNCTION IMediaInfoShellExt__table[] =
{
...
const IID *  _MediaInfoShellExt_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
