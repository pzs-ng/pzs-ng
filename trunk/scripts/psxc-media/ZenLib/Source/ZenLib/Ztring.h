...
public :
    ...
    Ztring& From_Number  (const float64,  int8u AfterComma=3, ztring_t Options=Ztring_Nothing);
        /// @brief convert number into Ztring
    Ztring& From_Number  (const float128, int8u AfterComma=3, ztring_t Options=Ztring_Nothing);
    #if defined (MACOSX)
        /// @brief convert number into Ztring
    ...
    static Ztring ToZtring  (const int32u   I,  int8u Radix=10)                  {Ztring A; A.From_Number(I, Radix); return A;};
    #if (MAXTYPE_INT>=64)
    static Ztring ToZtring  (const int64s   I,  int8u Radix=10)                  {Ztring A; A.From_Number(I, Radix); return A;};
    static Ztring ToZtring  (const int64u   I,  int8u Radix=10)                  {Ztring A; A.From_Number(I, Radix); return A;};
    #endif
    ...
    static Ztring ToZtring  (const float128 F, int8u AfterComma=3)               {return Ztring().From_Number(F, AfterComma);};
    #if defined (MACOSX)
